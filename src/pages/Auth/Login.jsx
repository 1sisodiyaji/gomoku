  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Lets Be a part of Gomoku , And showcase your skills here."
        />
        <title>Login | Gomoku </title>
        <meta property="og:title" content="Login | Gomoku" />
        <meta
        ...
        />
        <meta property="og:url" content="https://Gomoku.com/Login" />
          ...
          >
            <form>
                ...
                <div className="row d-flex justify-content-evenly align-items-center">
                  <div className="col-12">
                    <button
                      ...
                      onClick={login}
                    >
                      <img src="img/Google.png" height={26} alt="" />
              ...
              <div >
                <p >
                  New Here Please{" "}
                  <Link to="/Register" className="  mx-1 fw-bold" style={{ color: "#79b4e2" , textDecoration: 'underline' }} >
                    Register !
                  </Link>
                </p>
              </div>
